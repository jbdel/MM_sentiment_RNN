...
class EmbeddingWrapper(RNNCell):
  ...
  def __init__(self, cell, embedding, initializer=None,
               reuse=None):
...
class EmbeddingDropoutWrapper(RNNCell):
  """Operator adding dropout to inputs and outputs of the given cell."""

  def __init__(self, cell, embedding, input_keep_prob=1.0, output_keep_prob=1.0,
               state_keep_prob=1.0, variational_recurrent=False,
               input_size=None, dtype=None, seed=None, initializer=None,
               reuse=None):
  ...
  def set_dropout(self, dropout):
    # self._input_keep_prob = dropout
    self._state_keep_prob = dropout
    self._output_keep_prob = dropout
    return True
  ...
  def __call__(self, inputs, state, scope=None):
    ...
    if _should_dropout(self._input_keep_prob):
      embedded = self._dropout(embedded, "input",
                             self._recurrent_input_noise,
                             self._input_keep_prob)
    output, new_state = self._cell(embedded, state, scope)
...
class DropoutWrapper_custom(RNNCell):
  """Operator adding dropout to inputs and outputs of the given cell."""
